...
namespace SQLEngine::Testing::JSONQueryParser::Preparation
{
    ...
    auto CreateUsersTable() -> Interface::UTable
    {
        ...
        auto&& username =
            DataBase::CreateColumn("username", Interface::DynamicType::String);
        auto&& password =
            DataBase::CreateColumn("password", Interface::DynamicType::String);

        userID->AddElement(Interface::CreateUDynValue(1));
        username->AddElement(Interface::CreateUDynValue("John Doe"));
        password->AddElement(Interface::CreateUDynValue("hashed-password-1"));

        userID->AddElement(Interface::CreateUDynValue(2));
        username->AddElement(Interface::CreateUDynValue("Alice Smith"));
        password->AddElement(Interface::CreateUDynValue("hashed-password-2"));

        userID->AddElement(Interface::CreateUDynValue(3));
        username->AddElement(Interface::CreateUDynValue("Bob Jones"));
        password->AddElement(Interface::CreateUDynValue("hashed-password-3"));
    ...
    auto CreateTasksTable() -> Interface::UTable
    {
        ...
        auto&& dueDate =
            DataBase::CreateColumn("due-date", Interface::DynamicType::String);
        auto&& status =
            DataBase::CreateColumn("status", Interface::DynamicType::String);

        taskID->AddElement(Interface::CreateUDynValue(1));
        userID->AddElement(Interface::CreateUDynValue(1));
        title->AddElement(Interface::CreateUDynValue("Complete SQL Tutorial"));
        description->AddElement(Interface::CreateUDynValue(
            "Learn SQL basics and advanced queries"));
        dueDate->AddElement(Interface::CreateUDynValue("2024-02-29 18:00:00"));
        ...
        dueDate->AddElement(Interface::CreateUDynValue("2024-03-15 20:30:00"));
        status->AddElement(Interface::CreateUDynValue("Incomplete"));
        ...
        dueDate->AddElement(Interface::CreateUDynValue("2024-02-20 07:00:00"));
    ...
    auto CreateCategoriesTable() -> Interface::UTable
    {
        ...
        auto&& categoryID =
            DataBase::CreateColumn("category-id", Interface::DynamicType::Int);
