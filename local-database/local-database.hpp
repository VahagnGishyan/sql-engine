...
namespace SQLEngine::DBManager
{
    ...
    class LocalDatabase : public Interface::IDBManager
    {
       ...
       protected:
        virtual auto GetDatabaseOptional(const Interface::IDataBaseID& dbid)
            const -> std::optional<Interface::WDataBase>;
