...
class TestSQLQueryParser(unittest.TestCase):
    ...
    def test_select_query(self):
        ...
        query = "SELECT column1, column2 FROM large_table WHERE column2 <= 54"
        ...
        self.assertEqual(len(result.columns), 2)  # Modify as needed

        # Check the number of rows in the result
        self.assertGreaterEqual(len(result.get_rows()), 0)  # Modify as needed
