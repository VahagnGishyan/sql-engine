...
class TestComparisonConditions(unittest.TestCase):
    def test_equal(self):
        equal_condition = cond.Equal("random-text", 42)
    ...
    def test_not_equal(self):
        not_equal_condition = cond.NotEqual("random-text", 42)
    ...
    def test_greater_than(self):
        gt_condition = cond.GreaterThan("random-text", 42)
    ...
    def test_greater_than_or_equal_to(self):
        gte_condition = cond.GreaterThanOrEqualTo("random-text", 42)
    ...
    def test_less_than(self):
        lt_condition = cond.LessThan("random-text", 42)
    ...
    def test_less_than_or_equal_to(self):
        lte_condition = cond.LessThanOrEqualTo("random-text", 42)
