...
class TestColumnConstraintsUnique(unittest.TestCase):
    def test_constraint_unique_pass(self):
        ...
        my_column = create_column_with_constraints("my_column", "int", [constraint_unique])
        ...
        try:
            ...
            self.fail("ConstraintException should not be raised for unique values.")
    ...
    def test_constraint_unique_fail(self):
        ...
        try:
            ...
            self.fail("ConstraintException should be raised for non-unique values.")
